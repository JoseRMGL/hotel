    ...
    <div class="container">
        ...
        <form action="agregar_cliente" method="post">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="txtClienteId" name="txtClienteId" placeholder="Ingrese su No. de DPI">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="txtApellido" name="txtApellido" placeholder="Ingrese su Nombre">
            </div>
            <div class="mb-3">
                <label for="txtNit" class="form-label">Nit</label>
                <input type="number" class="form-control" id="txtNit" name="txtNit" placeholder="Ingrese su Direccion">
            </div>
            <div class="mb-3">
