  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="mb-3">
                ...
                <input type="number" class="form-control" id="txtHotelId" name="txtHotelId" placeholder="Ingrese su No. de DPI" value="<?=$datos['hotel_id'];?>" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="txtCorreo" name="txtCorreo" placeholder="Ingrese su Numero Movil" value="<?=$datos['correoelectronico'];?>">
            </div>
            <div class="mb-3">
