...
<html lang="en">
  <head>
    ...
    <title>Nuevas Recervaciones</title>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <form action="agregar_reservacion" method="post">
            <div class="mb-3">
                <label for="txtReservacionId" class="form-label">ID Reservacion</label>
                <input type="number" class="form-control" id="txtReservacionId" name="txtReservacionId" placeholder="Ingrese su No. de DPI">
            </div>
            <div class="mb-3">
                <label for="txtFecha" class="form-label">Fecha</label>
                <input type="date" class="form-control" id="txtFecha" name="txtFecha" placeholder="Ingrese su Apellido">
            </div>
            <div class="mb-3">
                <label for="txtClienteId" class="form-label">ID Cliente</label>
                <input type="number" class="form-control" id="txtClienteId" name="txtClienteId" placeholder="Ingrese su Nombre">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="txtDescripcion" name="txtDescripcion" placeholder="Ingrese su Telefono de Casa">
            </div>
            <div class="mb-3">
